...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.ForeignTableOptionsRecord;
...
public class ForeignTableOptions extends TableImpl<ForeignTableOptionsRecord> {
    ...
    private static final long serialVersionUID = 1240638496;
    ...
    public ForeignTableOptions() {
        this("foreign_table_options", null);
    }
    ...
    private ForeignTableOptions(String alias, Table<ForeignTableOptionsRecord> aliased) {
        this(alias, aliased, null);
    }

    private ForeignTableOptions(String alias, Table<ForeignTableOptionsRecord> aliased, Field<?>[] parameters) {
