...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.SqlSizingRecord;
...
public class SqlSizing extends TableImpl<SqlSizingRecord> {
    ...
    private static final long serialVersionUID = -1357283511;
    ...
    private SqlSizing(String alias, Table<SqlSizingRecord> aliased) {
        this(alias, aliased, null);
    }

    private SqlSizing(String alias, Table<SqlSizingRecord> aliased, Field<?>[] parameters) {
