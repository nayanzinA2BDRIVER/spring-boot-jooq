...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.ForeignServerOptionsRecord;
...
public class ForeignServerOptions extends TableImpl<ForeignServerOptionsRecord> {
    ...
    private static final long serialVersionUID = -1778757526;
    ...
    public ForeignServerOptions() {
        this("foreign_server_options", null);
    }
    ...
    private ForeignServerOptions(String alias, Table<ForeignServerOptionsRecord> aliased) {
        this(alias, aliased, null);
    }

    private ForeignServerOptions(String alias, Table<ForeignServerOptionsRecord> aliased, Field<?>[] parameters) {
