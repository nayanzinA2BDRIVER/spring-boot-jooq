...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.SqlSizingProfilesRecord;
...
public class SqlSizingProfiles extends TableImpl<SqlSizingProfilesRecord> {
    ...
    private static final long serialVersionUID = -1525115941;
    ...
    private SqlSizingProfiles(String alias, Table<SqlSizingProfilesRecord> aliased) {
        this(alias, aliased, null);
    }

    private SqlSizingProfiles(String alias, Table<SqlSizingProfilesRecord> aliased, Field<?>[] parameters) {
