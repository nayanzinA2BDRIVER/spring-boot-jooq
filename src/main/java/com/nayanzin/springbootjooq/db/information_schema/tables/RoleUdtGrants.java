...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.RoleUdtGrantsRecord;
...
public class RoleUdtGrants extends TableImpl<RoleUdtGrantsRecord> {
    ...
    private static final long serialVersionUID = -2082111600;
     ...
     */
    public final TableField<RoleUdtGrantsRecord, String> IS_GRANTABLE = createField("is_grantable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * Create a <code>information_schema.role_udt_grants</code> table reference
     */
    public RoleUdtGrants() {
        this("role_udt_grants", null);
    }
    ...
    private RoleUdtGrants(String alias, Table<RoleUdtGrantsRecord> aliased) {
        this(alias, aliased, null);
    }

    private RoleUdtGrants(String alias, Table<RoleUdtGrantsRecord> aliased, Field<?>[] parameters) {
