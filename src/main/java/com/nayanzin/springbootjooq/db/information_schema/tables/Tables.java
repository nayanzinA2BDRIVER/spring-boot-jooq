...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.TablesRecord;
...
public class Tables extends TableImpl<TablesRecord> {
    ...
    private static final long serialVersionUID = -1231586945;
     ...
     */
    public final TableField<TablesRecord, String> IS_INSERTABLE_INTO = createField("is_insertable_into", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * The column <code>information_schema.tables.is_typed</code>.
     */
    public final TableField<TablesRecord, String> IS_TYPED = createField("is_typed", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
