...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.UdtPrivilegesRecord;
...
public class UdtPrivileges extends TableImpl<UdtPrivilegesRecord> {
    ...
    private static final long serialVersionUID = 1897893094;
     ...
     */
    public final TableField<UdtPrivilegesRecord, String> IS_GRANTABLE = createField("is_grantable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * Create a <code>information_schema.udt_privileges</code> table reference
     */
    public UdtPrivileges() {
        this("udt_privileges", null);
    }
    ...
    private UdtPrivileges(String alias, Table<UdtPrivilegesRecord> aliased) {
        this(alias, aliased, null);
    }

    private UdtPrivileges(String alias, Table<UdtPrivilegesRecord> aliased, Field<?>[] parameters) {
