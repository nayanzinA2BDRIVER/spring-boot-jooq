...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.UserDefinedTypesRecord;
...
public class UserDefinedTypes extends TableImpl<UserDefinedTypesRecord> {
    ...
    private static final long serialVersionUID = 1857818488;
     ...
     */
    public final TableField<UserDefinedTypesRecord, String> IS_INSTANTIABLE = createField("is_instantiable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * The column <code>information_schema.user_defined_types.is_final</code>.
     */
    public final TableField<UserDefinedTypesRecord, String> IS_FINAL = createField("is_final", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
    ...
    private UserDefinedTypes(String alias, Table<UserDefinedTypesRecord> aliased) {
        this(alias, aliased, null);
    }

    private UserDefinedTypes(String alias, Table<UserDefinedTypesRecord> aliased, Field<?>[] parameters) {
