...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.SqlImplementationInfoRecord;
...
public class SqlImplementationInfo extends TableImpl<SqlImplementationInfoRecord> {
    ...
    private static final long serialVersionUID = -259772022;
    ...
    public SqlImplementationInfo() {
        this("sql_implementation_info", null);
    }
    ...
    private SqlImplementationInfo(String alias, Table<SqlImplementationInfoRecord> aliased) {
        this(alias, aliased, null);
    }

    private SqlImplementationInfo(String alias, Table<SqlImplementationInfoRecord> aliased, Field<?>[] parameters) {
