...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.ForeignServersRecord;
...
public class ForeignServers extends TableImpl<ForeignServersRecord> {
    ...
    private static final long serialVersionUID = -73834853;
    ...
    private ForeignServers(String alias, Table<ForeignServersRecord> aliased) {
        this(alias, aliased, null);
    }

    private ForeignServers(String alias, Table<ForeignServersRecord> aliased, Field<?>[] parameters) {
