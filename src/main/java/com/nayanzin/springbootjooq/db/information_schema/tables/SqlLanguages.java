...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.SqlLanguagesRecord;
...
public class SqlLanguages extends TableImpl<SqlLanguagesRecord> {
    ...
    private static final long serialVersionUID = -565534644;
    ...
    private SqlLanguages(String alias, Table<SqlLanguagesRecord> aliased) {
        this(alias, aliased, null);
    }

    private SqlLanguages(String alias, Table<SqlLanguagesRecord> aliased, Field<?>[] parameters) {
