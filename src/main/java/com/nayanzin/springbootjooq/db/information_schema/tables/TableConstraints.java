...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.TableConstraintsRecord;
...
public class TableConstraints extends TableImpl<TableConstraintsRecord> {
    ...
    private static final long serialVersionUID = 147534674;
     ...
     */
    public final TableField<TableConstraintsRecord, String> IS_DEFERRABLE = createField("is_deferrable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * The column <code>information_schema.table_constraints.initially_deferred</code>.
     */
    public final TableField<TableConstraintsRecord, String> INITIALLY_DEFERRED = createField("initially_deferred", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * The column <code>information_schema.table_constraints.enforced</code>.
     */
    public final TableField<TableConstraintsRecord, String> ENFORCED = createField("enforced", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
