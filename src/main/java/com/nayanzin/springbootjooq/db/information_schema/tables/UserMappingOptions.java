...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.UserMappingOptionsRecord;
...
public class UserMappingOptions extends TableImpl<UserMappingOptionsRecord> {
    ...
    private static final long serialVersionUID = -1906630761;
    ...
    public UserMappingOptions() {
        this("user_mapping_options", null);
    }
    ...
    private UserMappingOptions(String alias, Table<UserMappingOptionsRecord> aliased) {
        this(alias, aliased, null);
    }

    private UserMappingOptions(String alias, Table<UserMappingOptionsRecord> aliased, Field<?>[] parameters) {
