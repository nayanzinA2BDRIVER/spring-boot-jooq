...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.ColumnsRecord;
...
public class Columns extends TableImpl<ColumnsRecord> {
    ...
    private static final long serialVersionUID = 1053017823;
     ...
     */
    public final TableField<ColumnsRecord, String> IS_NULLABLE = createField("is_nullable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
     ...
     */
    public final TableField<ColumnsRecord, String> IS_SELF_REFERENCING = createField("is_self_referencing", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * The column <code>information_schema.columns.is_identity</code>.
     */
    public final TableField<ColumnsRecord, String> IS_IDENTITY = createField("is_identity", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
     ...
     */
    public final TableField<ColumnsRecord, String> IDENTITY_CYCLE = createField("identity_cycle", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
     ...
     */
    public final TableField<ColumnsRecord, String> IS_UPDATABLE = createField("is_updatable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");
