...
import com.nayanzin.springbootjooq.db.information_schema.tables.records.UsagePrivilegesRecord;
...
public class UsagePrivileges extends TableImpl<UsagePrivilegesRecord> {
    ...
    private static final long serialVersionUID = 1783763513;
     ...
     */
    public final TableField<UsagePrivilegesRecord, String> IS_GRANTABLE = createField("is_grantable", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "");

    /**
     * Create a <code>information_schema.usage_privileges</code> table reference
     */
    public UsagePrivileges() {
        this("usage_privileges", null);
    }
    ...
    private UsagePrivileges(String alias, Table<UsagePrivilegesRecord> aliased) {
        this(alias, aliased, null);
    }

    private UsagePrivileges(String alias, Table<UsagePrivilegesRecord> aliased, Field<?>[] parameters) {
