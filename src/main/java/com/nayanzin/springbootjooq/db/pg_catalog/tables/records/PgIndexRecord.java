...
public class PgIndexRecord extends TableRecordImpl<PgIndexRecord> implements Record20<Long, Long, Short, Short, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Object[], Long[], Long[], Object[], Object, Object> {

    private static final long serialVersionUID = -296322484;
    ...
    public PgIndexRecord(Long indexrelid, Long indrelid, Short indnatts, Short indnkeyatts, Boolean indisunique, Boolean indisprimary, Boolean indisexclusion, Boolean indimmediate, Boolean indisclustered, Boolean indisvalid, Boolean indcheckxmin, Boolean indisready, Boolean indislive, Boolean indisreplident, Object[] indkey, Long[] indcollation, Long[] indclass, Object[] indoption, Object indexprs, Object indpred) {
        ...
        set(4, indisunique);
        set(5, indisprimary);
        set(6, indisexclusion);
        set(7, indimmediate);
        set(8, indisclustered);
        set(9, indisvalid);
        set(10, indcheckxmin);
        set(11, indisready);
        set(12, indislive);
        set(13, indisreplident);
        set(14, indkey);
        set(15, indcollation);
        set(16, indclass);
        set(17, indoption);
