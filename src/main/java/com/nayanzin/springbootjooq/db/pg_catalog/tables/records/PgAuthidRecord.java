...
public class PgAuthidRecord extends TableRecordImpl<PgAuthidRecord> implements Record11<String, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Integer, String, Timestamp> {

    private static final long serialVersionUID = 1032670686;
     ...
     */
    @Override
    public Row11<String, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Integer, String, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row11<String, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Integer, String, Timestamp> valuesRow() {
     ...
     */
    @Override
    public PgAuthidRecord value11(Timestamp value) {
     ...
     */
    @Override
    public PgAuthidRecord values(String value1, Boolean value2, Boolean value3, Boolean value4, Boolean value5, Boolean value6, Boolean value7, Boolean value8, Integer value9, String value10, Timestamp value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgAuthidRecord(String rolname, Boolean rolsuper, Boolean rolinherit, Boolean rolcreaterole, Boolean rolcreatedb, Boolean rolcanlogin, Boolean rolreplication, Boolean rolbypassrls, Integer rolconnlimit, String rolpassword, Timestamp rolvaliduntil) {
        super(PgAuthid.PG_AUTHID);
