...
import com.nayanzin.springbootjooq.db.pg_catalog.tables.records.PgStatProgressVacuumRecord;
...
public class PgStatProgressVacuum extends TableImpl<PgStatProgressVacuumRecord> {
    ...
    private static final long serialVersionUID = 775958492;
    ...
    public PgStatProgressVacuum() {
        this("pg_stat_progress_vacuum", null);
    }
    ...
    private PgStatProgressVacuum(String alias, Table<PgStatProgressVacuumRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatProgressVacuum(String alias, Table<PgStatProgressVacuumRecord> aliased, Field<?>[] parameters) {
