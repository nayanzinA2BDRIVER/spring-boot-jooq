...
import com.nayanzin.springbootjooq.db.pg_catalog.tables.records.PgClassRecord;
...
public class PgClass extends TableImpl<PgClassRecord> {
    ...
    private static final long serialVersionUID = -1387260997;
     ...
     */
    public final TableField<PgClassRecord, Long> RELREWRITE = createField("relrewrite", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    /**
     * The column <code>pg_catalog.pg_class.relpartbound</code>.
     */
